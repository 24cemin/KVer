...
func TestHashStore(t *testing.T) {
	...
	t.Run("HappyPath_HSetGet", func(t *testing.T) {
		t.Parallel()
		_, hs, _ := setup()
		requireNoError(t, hs.HSet("hkey1", "f1", "v1", 0))
	...
	t.Run("HappyPath_HGetAll", func(t *testing.T) {
		t.Parallel()
		_, hs, _ := setup()
		requireNoError(t, hs.HSet("hkey2", "f1", "v1", 0))
		requireNoError(t, hs.HSet("hkey2", "f2", "v2", 0))
	...
	t.Run("HappyPath_HExists", func(t *testing.T) {
		t.Parallel()
		_, hs, _ := setup()
		requireNoError(t, hs.HSet("hkey3", "f1", "v1", 0))
	...
	t.Run("HappyPath_HDelete", func(t *testing.T) {
		t.Parallel()
		_, hs, _ := setup()
		requireNoError(t, hs.HSet("hkey4", "f1", "v1", 0))
	...
	t.Run("ErrorPath_StringKeyHSet", func(t *testing.T) {
		t.Parallel()
		kv, hs, _ := setup()
		requireNoError(t, kv.strings.Set("str_key", "val", 0))
	...
	t.Run("TTLPath_ExpiredHGet", func(t *testing.T) {
		t.Parallel()
		_, hs, _ := setup()
		requireNoError(t, hs.HSet("ttl_hash1", "f1", "v1", 100*time.Millisecond))
	...
	t.Run("TTLPath_UnexpiredHGetAll", func(t *testing.T) {
		t.Parallel()
		_, hs, _ := setup()
		requireNoError(t, hs.HSet("ttl_hash2", "f1", "v1", 100*time.Millisecond))
	...
	t.Run("TypeConflict_HashKeyLPush", func(t *testing.T) {
		t.Parallel()
		kv, _, _ := setup()
		requireNoError(t, kv.hashes.HSet("conflict_hash", "f1", "v1", 0))
	...
	t.Run("HappyPath_HSetOverwrite", func(t *testing.T) {
		t.Parallel()
		_, hs, _ := setup()
		requireNoError(t, hs.HSet("hkey5", "f1", "v1", 0))
		requireNoError(t, hs.HSet("hkey5", "f1", "v2", 0))
	...
	t.Run("HappyPath_HDeletePartial", func(t *testing.T) {
		t.Parallel()
		_, hs, _ := setup()
		requireNoError(t, hs.HSet("hkey6", "f1", "v1", 0))
		requireNoError(t, hs.HSet("hkey6", "f2", "v2", 0))
		requireNoError(t, hs.HDelete("hkey6", "f1"))
	...
	t.Run("HappyPath_HDeleteFull", func(t *testing.T) {
		t.Parallel()
		_, hs, _ := setup()
		requireNoError(t, hs.HSet("hkey_full_delete", "f1", "v1", 0))
	...
	t.Run("ErrorPath_ErrWrongType_HGet", func(t *testing.T) {
		t.Parallel()
		kv, hs, _ := setup()
		requireNoError(t, kv.strings.Set("h_wrong1", "val", 0))
	...
	t.Run("ErrorPath_ErrWrongType_HDelete", func(t *testing.T) {
		t.Parallel()
		kv, hs, _ := setup()
		requireNoError(t, kv.strings.Set("h_wrong2", "val", 0))
	...
	t.Run("ErrorPath_ErrWrongType_HGetAll", func(t *testing.T) {
		t.Parallel()
		kv, hs, _ := setup()
		requireNoError(t, kv.strings.Set("h_wrong3", "val", 0))
	...
	t.Run("ErrorPath_ErrWrongType_HExists", func(t *testing.T) {
		t.Parallel()
		kv, hs, _ := setup()
		requireNoError(t, kv.strings.Set("h_wrong4", "val", 0))
	...
	t.Run("ErrorPath_HDeleteNonExistentField", func(t *testing.T) {
		t.Parallel()
		_, hs, _ := setup()
		requireNoError(t, hs.HSet("hkey_fdel", "f1", "v1", 0))
	...
	t.Run("TypeRegistry_AfterFullDelete", func(t *testing.T) {
		t.Parallel()
		kv, hs, _ := setup()
		requireNoError(t, hs.HSet("k_fulldel", "f1", "v1", 0))
		requireNoError(t, hs.HDelete("k_fulldel", "f1"))
		err := kv.strings.Set("k_fulldel", "val", 0)
		if err != nil {
			t.Errorf("expected no error after full delete, got %v", err)
		}
	})
	...
	t.Run("HSet_ExpiredKeyIsEvicted", func(t *testing.T) {
		t.Parallel()
		_, hs, _ := setup()
		requireNoError(t, hs.HSet("k_expire", "f1", "v1", 100*time.Millisecond))
		time.Sleep(150 * time.Millisecond)
		requireNoError(t, hs.HSet("k_expire", "f2", "v2", 0))
	...
	t.Run("TTL_NotOverwrittenByZero", func(t *testing.T) {
		t.Parallel()
		_, hs, _ := setup()
		requireNoError(t, hs.HSet("k_no_overwrite", "f1", "v1", 200*time.Millisecond))
		requireNoError(t, hs.HSet("k_no_overwrite", "f2", "v2", 0))
		time.Sleep(250 * time.Millisecond)

		_, err := hs.HGet("k_no_overwrite", "f1")
		if err != ErrKeyNotFound {
			t.Errorf("expected ErrKeyNotFound for f1, got %v", err)
		}

		_, err = hs.HGet("k_no_overwrite", "f2")
		if err != ErrKeyNotFound {
			t.Errorf("expected ErrKeyNotFound for f2, got %v", err)
		}
	})
}
