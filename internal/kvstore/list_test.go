...
func TestListStore(t *testing.T) {
	...
	t.Run("HappyPath_RPushLRange", func(t *testing.T) {
		t.Parallel()
		_, ls, _ := setup()
		requireRPush(t, ls, "lkey2", 0, "a", "b", "c")
	...
	t.Run("HappyPath_LPop", func(t *testing.T) {
		t.Parallel()
		_, ls, _ := setup()
		requireRPush(t, ls, "lkey3", 0, "first", "second")
	...
	t.Run("HappyPath_RPop", func(t *testing.T) {
		t.Parallel()
		_, ls, _ := setup()
		requireRPush(t, ls, "lkey4", 0, "first", "second")
	...
	t.Run("HappyPath_LRangeFullList", func(t *testing.T) {
		t.Parallel()
		_, ls, _ := setup()
		requireRPush(t, ls, "lkey5", 0, "x", "y", "z")
	...
	t.Run("HappyPath_LRangeSpecific", func(t *testing.T) {
		t.Parallel()
		_, ls, _ := setup()
		requireRPush(t, ls, "lkey6", 0, "0", "1", "2", "3", "4")
	...
	t.Run("ErrorPath_LPopEmpty", func(t *testing.T) {
		t.Parallel()
		_, ls, _ := setup()
		requireRPush(t, ls, "empty_test1", 0, "a")
		requireLPop(t, ls, "empty_test1") // list is now empty
	...
	t.Run("ErrorPath_StringKeyLPush", func(t *testing.T) {
		t.Parallel()
		kv, ls, _ := setup()
		requireNoError(t, kv.strings.Set("strkey", "abc", 0))
	...
	t.Run("ErrorPath_HashKeyLPush", func(t *testing.T) {
		t.Parallel()
		kv, ls, _ := setup()
		requireNoError(t, kv.hashes.HSet("hashkey", "f", "v", 0))
	...
	t.Run("TTLPath_UnexpiredLRange", func(t *testing.T) {
		t.Parallel()
		_, ls, _ := setup()
		requireLPush(t, ls, "ttl_list2", 100*time.Millisecond, "a")
	...
	t.Run("LimitControl_LRangeOutOfBounds", func(t *testing.T) {
		t.Parallel()
		_, ls, _ := setup()
		requireRPush(t, ls, "limit_list", 0, "x")
	...
	t.Run("LimitControl_LRangeNegativeIndices", func(t *testing.T) {
		t.Parallel()
		_, ls, _ := setup()
		requireRPush(t, ls, "neg_list", 0, "a", "b", "c")
	...
	t.Run("LimitControl_LRangeStartGreaterThanStop", func(t *testing.T) {
		t.Parallel()
		_, ls, _ := setup()
		requireRPush(t, ls, "rev_list", 0, "a", "b")
	...
	t.Run("HappyPath_LPushOrderVerify", func(t *testing.T) {
		t.Parallel()
		_, ls, _ := setup()
		requireLPush(t, ls, "lkey_order", 0, "val1", "val2", "val3")
	...
	t.Run("TypeRegistry_AfterFullPop", func(t *testing.T) {
		t.Parallel()
		kv, ls, _ := setup()
		requireRPush(t, ls, "k_fullpop", 0, "a")
		requireLPop(t, ls, "k_fullpop")
		err := kv.strings.Set("k_fullpop", "val", 0)
		if err != nil {
			t.Errorf("expected no error after full pop, got %v", err)
		}
	})
	...
	t.Run("TypeRegistry_SetType", func(t *testing.T) {
		t.Parallel()
		kv, ls, _ := setup()
		requireRPush(t, ls, "k_settype", 0, "a")
	...
	t.Run("ErrorPath_ErrWrongType_RPush", func(t *testing.T) {
		t.Parallel()
		kv, ls, _ := setup()
		requireNoError(t, kv.strings.Set("k_wrong_rpush", "val", 0))
	...
	t.Run("ErrorPath_ErrWrongType_LPop", func(t *testing.T) {
		t.Parallel()
		kv, ls, _ := setup()
		requireNoError(t, kv.strings.Set("k_wrong_lpop", "val", 0))
	...
	t.Run("ErrorPath_ErrWrongType_RPop", func(t *testing.T) {
		t.Parallel()
		kv, ls, _ := setup()
		requireNoError(t, kv.strings.Set("k_wrong_rpop", "val", 0))
	...
	t.Run("ErrorPath_ErrWrongType_LRange", func(t *testing.T) {
		t.Parallel()
		kv, ls, _ := setup()
		requireNoError(t, kv.strings.Set("k_wrong_lrange", "val", 0))
	...
	t.Run("ErrorPath_ErrWrongType_LLen", func(t *testing.T) {
		t.Parallel()
		kv, ls, _ := setup()
		requireNoError(t, kv.strings.Set("k_wrong_llen", "val", 0))
	...
	t.Run("TTLPath_RPushTTL", func(t *testing.T) {
		t.Parallel()
		_, ls, _ := setup()
		requireRPush(t, ls, "ttl_rpush", 100*time.Millisecond, "a")
		time.Sleep(150 * time.Millisecond)
